        ...
        <div className="flex items-center space-x-2">
          <div className="flex-1">
            <input
              ...
              className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none bg-white transition-all duration-200 placeholder-gray-500 text-sm text-gray-900"
              disabled={isTyping}
            />
          </div>
          <button
